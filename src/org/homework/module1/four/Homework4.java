package org.homework.module1.four;

import org.homework.module1.four.ex1.Bus;
import org.homework.module1.four.ex1.CarWash;
import org.homework.module1.four.ex1.PassengerCar;
import org.homework.module1.four.ex1.Vehicle;
import org.homework.module1.four.ex2.Duck;
import org.homework.module1.four.ex2.FlyException;
import org.homework.module1.four.ex2.Flyable;
import org.homework.module1.four.ex2.Plane;
import org.homework.module1.four.ex3.*;
...
public class Homework4 {
    ...
    public static void ex1() {
        ...
        Vehicle[] vehicles = {new PassengerCar(false, 1.8, 2, 5),
                new PassengerCar(false, 1.8, 2, 5),
                new PassengerCar(false, 1.8, 2, 5),
                new PassengerCar(false, 1.8, 2, 5),
                new Bus(false, 2.3, 3, 12),
                new Bus(false, 2.3, 3, 12),
                new Bus(false, 2.3, 3, 12),
                new Bus(false, 2.3, 3, 12),
                new Bus(false, 2.3, 3, 12)};
        System.out.println("Сколько мэрия заплатит денег за мойку машин " + new CarWash().washCar(vehicles));
    }
    ...
    public static void ex2() {
        ...
        Plane planeOne = new Plane(10);
        Plane planeTwo = new Plane(-1);
        Flyable[] flyables = {duckOne, duckTwo, planeOne, planeTwo};
    ...
    public static void ex3() {
        ...
        SoundMaker[] soundMakers = {new Human(), new Worker(), new Driver(), new Bird()};
